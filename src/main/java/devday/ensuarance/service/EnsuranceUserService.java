...
import devday.ensuarance.entity.UserRole;
...
public class EnsuranceUserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(final String username)
        ...
        devday.ensuarance.entity.User user = userRepository.findByUsername(username);
    ...
    private User buildUserForAuthentication(devday.ensuarance.entity.User user,
